...
\hypersetup{
	pdftitle={Uma Proposta de Acionador Externo de Baixo Custo Baseado em Sopro}
...
\author[Erick M. Campos]
{\large \textbf{Erick Modesto Campos}\vspace{.2cm}}
...
Orientador: MSc. Cassio Trindade Batista\\
...
\date{\small{03 de Agosto de 2018}}
...
\date{
	\normalsize
	Erick M. Campos (\href{mailto:erickcampos@ufpa.br}{\tt erickcampos@ufpa.br})\\[1pt]
