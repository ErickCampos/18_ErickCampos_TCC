...
\begin{figure}
	\centering
	\subfloat[Conector TS.\label{fig:ts}]  {\includegraphics[width=0.50\linewidth]{fig/ts}}
	\subfloat[Conector TRS.\label{fig:trs}]{\includegraphics[width=0.50\linewidth]{fig/trs}}
	\caption{Conectores de áudio.}
	\label{fig:conector}
\end{figure}
