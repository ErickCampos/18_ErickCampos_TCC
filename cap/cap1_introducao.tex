...
economicamente para grande parte da população. Apesar de existir uma grande 
...
identificasse um clique involuntário quando a pessoa piscasse de forma
...
movimentar quando for reconhecido o comando \textit{stop}. Em relação ao evento
...
problemas, por exemplo, caso o usuário deseje mover o cursor para uma
...
\begin{figure}
	\centering
	\subfloat[Músculo masseter.\label{fig:masseter}]{\includegraphics[width=0.48\linewidth]{fig/masseter}}
	\quad
	\subfloat[Músculo risório.\label{fig:risorio}]  {\includegraphics[width=0.48\linewidth]{fig/risorio}}
	\caption{Músculos localizados na lateral da face.}
	\vspace{-1cm}
	\caption*{\textbf{Fonte: }Extraído de~\cite{musculo}.}
\end{figure}
